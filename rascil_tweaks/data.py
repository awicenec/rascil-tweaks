"""
rascil_tweaks component module.

This is the module of rascil_tweaks containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/rascil_tweaks.MyData/String/readonly/
